...
const Skills = (props) => {
  return (
    <div id="skills" className={s.skills}>
      ...
      <div className={s.box}>
        <div className={s.miniBox}><img src={js}></img></div>
        <div className={s.miniBox}><img src={css}></img></div>
        <div className={s.miniBox}><img src={git}></img></div>
        <div className={s.miniBox}><img src={html}></img></div>
        <div className={s.miniBox}><img src={react}></img></div>
        <div className={s.miniBox}><img src={redux}></img></div>
      ...
      <div><button className={n.btn}>Hire Me</button></div>
    </div>
  );
};
